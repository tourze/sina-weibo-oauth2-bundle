...
class SinaWeiboOAuth2CleanupCommandTest extends KernelTestCase
{
    ...
    {
        $command = self::getContainer()->get(SinaWeiboOAuth2CleanupCommand::class);
        
        $commandTester = new CommandTester($command);
        $result = $commandTester->execute([]);
        
        $this->assertEquals(0, $result);
        $this->assertStringContainsString('Cleaned up 0 expired states', $commandTester->getDisplay());
    }
}